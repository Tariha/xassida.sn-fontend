export const about = [
  ...
  },
  {
    ...
    links: [
      {
        name: "whatsapp",
        href: "https://chat.whatsapp.com/JHyMbb1hOLj51yTXKy6fwM",
      },
    ],
  },
]
...
export const footer = {
  para1:
    "Notre application offre une expérience de lecture numérique exceptionnelle pour les Xassidas, soigneusement classés par Confrérie et Auteur, et ce, accompagnés d'une transcription automatique. Nos utilisateurs ont la possibilité de télécharger les Xassidas au format PDF, tout en profitant d'extraits audio des récitations pour une immersion totale.",
  para2:
    "Nous sommes enchantés de constater votre désir de participer à la collecte de Xassidas pour notre application. Votre contribution revêt une grande importance pour nous, car elle nous permet d'enrichir notre collection de Xassidas et ainsi offrir une expérience complète à nos utilisateurs.",
}
